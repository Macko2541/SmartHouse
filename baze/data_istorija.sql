...
CREATE TABLE `istorija` (
  ...
  `nazivKorisnika` varchar(255) NOT NULL,
  `nazivPesme` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `istorija` VALUES (1,1,'Djoleo','Behind Blue Eyes'),(2,1,'Djoleo','Zombie'),(3,1,'Djoleo','I did it my way'),(4,2,'Marko','Sweet dreams'),(5,2,'Marko','Legendary');
